...
import 'package:sevvn_admin/data/admin_support_repository.dart' as support;
import 'package:sevvn_admin/data/clients_repository.dart';
import 'package:sevvn_admin/data/modules_catalog_repository.dart';
...
class _ClientDetailPageState extends State<ClientDetailPage> {
  ...
  /// Sevvn pode querer conferir o catálogo inteiro) mas sem toggle, pra
  /// não liberar cortesia de algo que ainda não tem tela nenhuma. Só a
  /// equipe Sevvn vê essa tela; não existe equivalente no portal do hotel
  /// (ver PATCH /api/platform-admin/hotels/{hotelId}).
