...
import 'package:sevvn_admin/site_config.dart';
import 'package:sevvn_admin/theme/konekto_brand.dart';

/// Paleta clara/rosa da marca — mesma usada no site e no portal web
/// (#FF2E88/#16181D/#F7F5F3/#FAFAF9). Escopada só a esta tela: o resto do
/// admin ainda está no tema escuro/dourado legado de `KonektoBrand`,
/// então os tokens não são reaproveitados daqui pra não mudar nenhuma
/// outra tela sem revisão visual.
class _LoginPalette {
  _LoginPalette._();
...
/// cartão de login do site institucional ("Área do hotel" ->
