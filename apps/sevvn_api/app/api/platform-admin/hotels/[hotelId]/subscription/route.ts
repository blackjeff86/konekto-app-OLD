...
// Upsert do plano/assinatura do hotel — quem seta isso é sempre o time da
// Sevvn pelo admin da plataforma, nunca o hotel. "Status do pagamento"
// nesta v1 é um campo manual (sem fatura/boleto real ainda, isso é fase 2).
